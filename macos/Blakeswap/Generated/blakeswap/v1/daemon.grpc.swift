...
internal enum Blakeswap_V1_DaemonService: Sendable {
    ...
    internal enum Method: Sendable {
        ...
        internal enum ListFills: Sendable {
            ...
            internal typealias Input = Blakeswap_V1_FillQuery
            /// Response type for "ListFills".
            internal typealias Output = Blakeswap_V1_FillPage
...
extension Blakeswap_V1_DaemonService {
    ...
    internal protocol ClientProtocol: Sendable {
        ...
        ///
        /// - Parameters:
        ///   - request: A request containing a single `Blakeswap_V1_FillQuery` message.
        ///   - serializer: A serializer for `Blakeswap_V1_FillQuery` messages.
        ///   - deserializer: A deserializer for `Blakeswap_V1_FillPage` messages.
        ///   - options: Options to apply to this RPC.
        ///   - handleResponse: A closure which handles the response and returns its result to
        ///       the caller. Returning from the closure will cancel the RPC if it hasn't
        ///       already finished.
        ...
        func listFills<Result>(
            request: GRPCCore.ClientRequest<Blakeswap_V1_FillQuery>,
            serializer: some GRPCCore.MessageSerializer<Blakeswap_V1_FillQuery>,
            deserializer: some GRPCCore.MessageDeserializer<Blakeswap_V1_FillPage>,
            options: GRPCCore.CallOptions,
            onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<Blakeswap_V1_FillPage>) async throws -> Result
        ) async throws -> Result where Result: Sendable
    ...
    internal struct Client<Transport>: ClientProtocol where Transport: GRPCCore.ClientTransport {
        ...
        internal func listFills<Result>(
            ...
            deserializer: some GRPCCore.MessageDeserializer<Blakeswap_V1_FillPage>,
            options: GRPCCore.CallOptions = .defaults,
            onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<Blakeswap_V1_FillPage>) async throws -> Result = { response in
                try response.message
            }
        ) async throws -> Result where Result: Sendable {
            try await self.client.unary(
                request: request,
                descriptor: Blakeswap_V1_DaemonService.Method.ListFills.descriptor,
                serializer: serializer,
                deserializer: deserializer,
                options: options,
                onResponse: handleResponse
...
extension Blakeswap_V1_DaemonService.ClientProtocol {
    ...
    internal func listFills<Result>(
        ...
        try await self.listFills(
            request: request,
            serializer: GRPCProtobuf.ProtobufSerializer<Blakeswap_V1_FillQuery>(),
            deserializer: GRPCProtobuf.ProtobufDeserializer<Blakeswap_V1_FillPage>(),
            options: options,
            onResponse: handleResponse
        )
    }
...
extension Blakeswap_V1_DaemonService.ClientProtocol {
    ...
    /// - Returns: The result of `handleResponse`.
    internal func listFills<Result>(
        _ message: Blakeswap_V1_FillQuery,
        metadata: GRPCCore.Metadata = [:],
        options: GRPCCore.CallOptions = .defaults,
        onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<Blakeswap_V1_FillPage>) async throws -> Result = { response in
            try response.message
        ...
        let request = GRPCCore.ClientRequest<Blakeswap_V1_FillQuery>(
            message: message,
            metadata: metadata
        )
