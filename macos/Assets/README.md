...
`AppIcon.png` is the original artwork generated with the built-in imagegen tool on September 5, 2026. The macOS build packages this image into `AppIcon.icns` at standard 1× and 2× resolutions using Apple's tools. The source PNG's transparency is preserved.
