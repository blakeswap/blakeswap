...
| Header observation continuity | Network PoW limits for both header formats, disconnected confirmation/median-time ranges, malformed/short batches, tip replacement and cached-range reorgs |
